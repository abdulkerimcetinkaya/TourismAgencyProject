...
public class ReservationDao {
    ...
    public Reservation match(ResultSet rs) throws SQLException {
        ...
        obj.setReservation_guest_id(rs.getString("guest_citizen_id"));
        obj.setReservation_mail(rs.getString("guest_mail"));
        obj.setReservation_phone(rs.getString("guest_phone"));
        return obj;
    }
    ...
    public boolean save(Reservation reservation) {
        ...
        try {
            ...
            pr.setString(7, reservation.getReservation_guest_id());
            pr.setString(8, reservation.getReservation_mail());
            pr.setString(9, reservation.getReservation_phone());
    ...
    public boolean update(Reservation reservation) {
        ...
        try {
            ...
            pr.setString(3, reservation.getReservation_guest_id());
            pr.setString(4, reservation.getReservation_mail());
            pr.setString(5, reservation.getReservation_phone());
